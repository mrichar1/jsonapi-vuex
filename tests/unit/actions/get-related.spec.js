...
describe("getRelated", function() {
  let json_widget_1, json_widget_2, json_widget_3, norm_widget_1, norm_widget_2,
    store_widget_1, store_widget_2, store_widget_1_3, jsonapiModule,
    stub_context;
  ...
  it("Should throw an error if passed an object with no id", function() {
    ...
    expect(() => jsonapiModule.actions.getRelated(stub_context, norm_widget_1)).to.throw("No id specified")
  })
  ...
  it("should get a record's single related item (using 'data')", async function() {
    ...
    let res = await jsonapiModule.actions.getRelated(stub_context, norm_widget_1)
  ...
  it("should get a record's related items (using 'data')", async function() {
    ...
    let res = await jsonapiModule.actions.getRelated(stub_context, norm_widget_2)
  ...
  it("should return related data for a specific relname", async function() {
    ...
    let res = await jsonapiModule.actions.getRelated(stub_context, "widget/3/widgets")
